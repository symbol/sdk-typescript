(function(nacl) {
    ...
    function crypto_sign_hash(sm, keypair, data, hasher) {
      ...
      hasher.update(keypair.privateKey);
      privHash = hasher.digest();
    ...
    function crypto_verify_hash(signature, pk, data, hasher) {
      ...
      scalarbase(q, signature.subarray(64/2));
      add(p, q);
      pack(t, p);

      return 0 === crypto_verify_32(signature, 0, t, 0);
    }
