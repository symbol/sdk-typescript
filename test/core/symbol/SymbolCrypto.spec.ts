...
describe('Symbol Crypto', () => {
    ...
    const customerIV = Converter.hexToUint8('1D253DAF5C080DF0A3FD3F82');
    const emptyKey = new Key(new Uint8Array());

    const encodeAndDecodeAssert = (customerIV?: Uint8Array): Uint8Array => {
        // Act:
        const encoded = encode(sender.privateKey, recipient.publicKey, messageBytes, customerIV);
    ...
    describe('Round Trip Test', () => {
        ...
        it('Can encode and decode message using provided IV', () => {
            encodeAndDecodeAssert(customerIV);
        });
    });
    ...
    describe('Edge Case Tests', () => {
        ...
        it('decode throws if using invalid payload', () => {
            ...
            // Act+Assert:
            expect(encoded.length).greaterThan(28);
            expect(() => {
