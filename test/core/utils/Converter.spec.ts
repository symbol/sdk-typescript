...
describe('Converter', () => {
    describe('toByte', () => {
        ...
        it('cannot convert invalid hex chars to byte', () => {
            ...
            pairs.forEach((pair) => {
                ...
                expect(() => {
                    Converter.toByte(pair[0], pair[1]);
    ...
    describe('hexToUint8', () => {
        ...
        it('cannot parse hex string with invalid characters into array', () => {
            // Assert:
            expect(() => {
                Converter.hexToUint8('abcdef012345G789ABCDEF');
        ...
        it('cannot parse hex string with invalid size into array', () => {
            // Assert:
            expect(() => {
                Converter.hexToUint8('abcdef012345G789ABCDE');
    ...
    describe('hexToUint8Reverse', () => {
        it('can parse empty hex string into array', () => {
            // Act:
            const actual = Converter.hexToUint8Reverse('');
        ...
        it('can parse valid hex string into array', () => {
            // Act:
            const actual = Converter.hexToUint8Reverse('026ee415fc15');
        ...
        it('can parse valid hex string containing all valid hex characters into array', () => {
            // Act:
            const actual = Converter.hexToUint8Reverse('abcdef0123456789ABCDEF');
        ...
        it('cannot parse hex string with invalid characters into array', () => {
            // Assert:
            expect(() => {
                Converter.hexToUint8Reverse('abcdef012345G789ABCDEF');
            }).to.throw('unrecognized hex char');
        });
        ...
        it('cannot parse hex string with invalid size into array', () => {
            // Assert:
            expect(() => {
                Converter.hexToUint8Reverse('abcdef012345G789ABCDE');
            }).to.throw('hex string has unexpected size');
        });
    });
    ...
    describe('uint8ToUint32', () => {
        it('uint8 array with zero length can be converted to uint32 array', () => {
            // Act:
            const actual = Converter.uint8ToUint32(Uint8Array.of());
        ...
        it('uint8 array with length multiple of four can be converted to uint32 array', () => {
            // Act:
            const actual = Converter.uint8ToUint32(Uint8Array.of(0x02, 0x6e, 0x89, 0xab, 0xcd, 0xef, 0xe4, 0x15));
        ...
        it('uint8 array with length not multiple of four cannot be converted to uint32 array', () => {
            // Assert:
            expect(() => {
                Converter.uint8ToUint32(Uint8Array.of(0x02, 0x6e, 0xe4, 0x15, 0x15));
    ...
    describe('uint32ToUint8', () => {
        it('uint32 array with zero length can be converted to uint8 array', () => {
            // Act:
            const actual = Converter.uint32ToUint8(Uint32Array.of());
        ...
        it('uint32 array with nonzero length can be converted to uint8 array', () => {
            // Act:
            const actual = Converter.uint32ToUint8(Uint32Array.of(0xab896e02, 0x15e4efcd));
    ...
    describe('utf8ToHex', () => {
        it('utf8 text to hex', () => {
            // Act:
            const actual = Converter.utf8ToHex('test words |@#¢∞¬÷“”≠[]}{–');
        ...
        it('utf8 text to hex', () => {
            // Act:
            const actual = Converter.utf8ToHex('先秦兩漢');
        ...
        it('utf8 text containing emoji to hex', () => {
            // Act:
            const actual = Converter.utf8ToHex('😀こんにちは😀');
        ...
        it('utf8 text to hex with control char', () => {
            // Act:
            const actual = Converter.utf8ToHex(String.fromCodePoint(0x0f) + ' Hello World!');
    ...
    describe('signed <-> unsigned byte', () => {
        ...
        describe('uint8ToInt8', () => {
            ...
            for (const testCase of failureTestCases) {
                it(`cannot convert number that is ${testCase.description}`, () => {
                    // Assert:
                    expect(() => Converter.uint8ToInt8(testCase.input)).to.throw(`input '${testCase.input}' is out of range`);
                });
            }
            ...
            for (const testCase of testCases) {
                it(`can convert ${testCase.description}`, () => {
                    // Act:
                    const value = Converter.uint8ToInt8(testCase.unsigned);
        ...
        describe('int8ToUint8', () => {
            ...
            for (const testCase of failureTestCases) {
                it(`cannot convert number that is ${testCase.description}`, () => {
                    // Assert:
                    expect(() => Converter.int8ToUint8(testCase.input)).to.throw(`input '${testCase.input}' is out of range`);
                });
            }
            ...
            for (const testCase of testCases) {
                it(`can convert ${testCase.description}`, () => {
                    // Act:
                    const value = Converter.int8ToUint8(testCase.signed);
    ...
    describe('utf8ToUni8', () => {
        it('should convert numeric string to Uint8Array', () => {
            ...
            // Act:
            const uint = Converter.utf8ToUint8(actual);
        ...
        it('should convert utf string to Uint8Array', () => {
            ...
            // Assert:
            expect(uint.length).to.be.equal(actual.length);
            expect(Converter.uint8ToHex(uint)).to.be.equal('74657374');
        });
    });
    ...
    describe('uint8ToUtf8', () => {
        it('should convert Uint8Array to numericString', () => {
            ...
            const actual = Converter.utf8ToUint8(expected);
            // Act:
            const result = Converter.uint8ToUtf8(actual);
    ...
    describe('numberToUint8Array', () => {
        it('should convert to number and back', () => {
            ...
            const array = Converter.numberToUint8(input, 4);
            // Act:
            const result = Converter.uint8ToNumber(array);
